...
actorOpts = rlOptimizerOptions( ...
    ...
    GradientThreshold = 1, ...
    L2RegularizationFactor = 1e-5); %1e-5
...
% --- Learning parameters ---
agentOpts.DiscountFactor = 0.99;         % Long-horizon reward (for stable gait)
...
ouNoise.Variance = 0.6;                   % Initial exploration intensity
ouNoise.VarianceDecayRate = 1e-7;         % Gradually reduce noise
ouNoise.VarianceMin = 0.2;               % Keep small exploration for fine-tuning
